          ...
          <div class="row">
            ...
            <div class="col-lg-6 col-5 my-auto text-end">
              <div class="dropdown float-lg-end pe-4">
                <a href="#" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#siswaModal">
          ...
          <table class="table align-middle table-hover table-borderless">
                ...
                <tbody class="text-center">
                    @forelse($siswa as $item)
                        <tr>
                            <td>{{ $loop->index + 1 + ($siswa->currentPage() - 1) * $siswa->perPage() }}</td>
                            ...
                            <td>
                                <a href="#" class="fa fa-edit text-primary" data-bs-toggle="modal" data-bs-target="#editSiswa{{$item->id}}"></a>
                                ...
                                @include('UserManajement.siswa.edit')
                            </td>
                        </tr>
                    @empty
                        <tr>
...
@include('UserManajement.siswa.create')
@endsection
